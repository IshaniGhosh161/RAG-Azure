...
from backend.config import HF_EMBEDDING_MODEL, HF_EMBEDDING_DEVICE, HF_EMBEDDING_BATCH_SIZE
...
class NomicEmbeddings:
    ...
    def __init__(
        ...
        self.model_name = model_name or HF_EMBEDDING_MODEL

        self.device = device or HF_EMBEDDING_DEVICE

        self.batch_size = batch_size or int(HF_EMBEDDING_BATCH_SIZE)
